...
function validasi(form_data){
  ...
  if (form_data.pegawai_website.value == ""){
    alert("Anda belum mengisikan Website.");
    form_data.pegawai_website.focus();
    return (false);
  }
...
<?php
	...
	$tanggal = tgl_form($r_data['pegawai_tgl_lhr']);
	...
	<tr align='center'>
		...
		if($r_pegawai[pegawai_foto] != '')
			echo "<img src='images/$r_pegawai[pegawai_foto]' width='205px' title='$r_pegawai[pegawai_nama] ($r_pegawai[pegawai_kode])' id='foto'>";
		else
	...
	<tr>
		...
		<td><input type='text' value='$r_pegawai[pegawai_tmpt_lhr]' name='pegawai_tmpt_lhr' size='20' id='text_input1'/> / <input type='text' value='$tanggal' name='pegawai_tgl_lhr' size='10' id='datepicker'/> &nbsp;&nbsp;&nbsp;dd/mm/yyyy</td>
	</tr>
	<tr>
		<th>Agama</th>
		<td>
	...
	<tr>
		<th>Alamat</th>
		<td>
			&nbsp;&nbsp;&nbsp;Jl. <input type='text' value='$r_pegawai[pegawai_jln]' maxlength='50' size='20' class='field text' name='pegawai_jln' /> 
			No. <input type='text' value='$r_pegawai[pegawai_no]' maxlength='3' size='1' class='field text' name='pegawai_no' /> 
			...
			Desa/Kelurahan <input type='text' value='$r_pegawai[pegawai_desa]' maxlength=50' size='20' class='field text' name='pegawai_desa' />
			Kecamatan <input type='text' value='$r_pegawai[pegawai_kecamatan]' maxlength=50' size='25' class='field text' name='pegawai_kecamatan' />
		</td>
	</tr>
	<tr>
		<th></th>
	...
	<tr>
		<th>Kode Pos</th>
		<td><input type='text' value='$r_pegawai[pegawai_kodepos]' name='pegawai_kodepos' size='5' maxlength='5' id='text_input1' onkeypress='return isNumberKey(event)'/></td>
	</tr>
	<tr>
		<th>Telepon/HP</th>
