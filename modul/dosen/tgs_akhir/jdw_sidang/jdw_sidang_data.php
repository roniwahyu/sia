<?php
	...
	$q_jadwal=mssql_query("
								...
								WHERE tt_jadwal_sidang.periode_id = '$_GET[periode]'   
									AND  tt_jadwal_sidang.mahasiswa_nim LIKE '$_GET[mahasiswa]'
	...
	<br class='clear'>
	<br class='clear'>
	<a href='modul/dosen/tgs_akhir/jdw_sidang/pdf_jdw_sidang.php?periode=$_GET[periode]' target='_parent' title='Save Jadwal Sidang Mahasiswa Bimbingan'><img src='template/images/page_save.png'> <b>Save</b></a>
	&nbsp;&nbsp;&nbsp;<a href='modul/dosen/tgs_akhir/jdw_sidang/pdf_jdw_sidang.php?periode=$_GET[periode]' target='_parent' title='Print Jadwal Sidang Mahasiswa Bimbingan'><img src='template/images/printer.png'> <b>Print</b></a>";
?>