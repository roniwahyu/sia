...
switch($_GET[act]){
  // Tampil jurusan Utama
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
          $("#periode").change(function(){
            ...
            $.ajax({
                url: "modul/dosen/tgs_akhir/jdw_penguji/jdw_penguji_data.php",
                data: "periode="+periode,
                cache: false,
                success: function(msg){
                    $("#jdw_penguji").html(msg);
                }
            });
          });
        });
	...
	echo"
	<div class='content'>
	<h3>Tugas Akhir &#187; Jadwal Penguji</h3>
	<br class='clear'/>
	<b>Tahun Ajaran</b>
	...
	$q_jadwal=mssql_query("
								...
								WHERE     ((tt_jadwal_sidang.penguji_kode_1 = '$_SESSION[pegawai_kode]') OR (tt_jadwal_sidang.penguji_kode_2 = '$_SESSION[pegawai_kode]'))
									AND tt_jadwal_sidang.periode_id='$periode'
	...
	<br class='clear'>
	<br class='clear'>
	<a href='$pdf?periode=$periode' target='_parent' title='Save Jadwal Penguji'><img src='template/images/page_save.png'> <b>Save</b></a>
	&nbsp;&nbsp;&nbsp;<a href='$print?periode=$periode' target='_blank' title='Print Jadwal Penguji'><img src='template/images/printer.png'> <b>Print</b></a>
	</div>
	</div>";
    break;
}
